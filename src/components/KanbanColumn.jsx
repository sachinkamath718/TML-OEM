...
const COL_STYLES = {
  ...
  'In Process': { bg: '#FFF8F0', text: '#D9480F', border: '#FFD8A8', dot: '#F76707' },
  ...
  return (
    <div style={{ flex: 1, minWidth: 195, maxWidth: 260 }}>
      ...
      <div style={{
        ...
        background: cs.bg, borderRadius: 8,
          ...
          {bulkMode && orders.length > 0 && (
            <div
              ...
              style={{
                ...
                border: `2px solid ${allSelected ? '#2563EB' : someSelected ? '#93C5FD' : cs.text}`,
                background: allSelected ? '#2563EB' : someSelected ? '#DBEAFE' : 'transparent',
            ...
            >
              ...
              {someSelected && !allSelected && (
                <div style={{ width: 6, height: 2, background: '#2563EB', borderRadius: 1 }} />
              )}
            </div>
          )}
          <span style={{ fontSize: 11, fontWeight: 700, color: cs.text, letterSpacing: 0.5 }}>
            {col.toUpperCase()}
          </span>
        </div>
        <span style={{
          fontSize: 11, fontWeight: 700, color: cs.text,
          background: '#fff', borderRadius: 10, padding: '1px 8px',
          border: `1px solid ${cs.border}`,
        }}>
          {orders.length}
        </span>
